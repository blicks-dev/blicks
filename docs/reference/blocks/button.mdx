---
title: "Button"
description: "A shadcn-style action button with variants, sizes, links, and optional icons."
---

<Info>
Generated from `packages/blicks/resources/blocks/button/block.json` and `readme.md`. Do not hand-edit this page.
</Info>
...
`gridChild.*` · `typography.*` · `colors.*` · `spacing.*` · `border.*` · `effects.*`
