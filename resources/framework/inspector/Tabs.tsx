...
export type TabId = 'settings' | 'style' | 'advanced' | 'css';
...
const TAB_ICONS: Record< TabId, JSX.Element > = {
	...
	css: ico( <path d="M8.5 6 3 12l5.5 6M15.5 6 21 12l-5.5 6" /> ),
};
 ...
 * sub-nav, not the inspector's top-level nav. Settings / Advanced / CSS render straight into
 * the pane with no rail at all.
 */
